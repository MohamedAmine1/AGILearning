...
<head>
    ...
    <title>AGILearning : LUBRIFIANT</title>
                        ...
                        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                            ...
                            <li class="dropdown" class="active">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li class="active"><a href="LUBRIFIANT.jsp">LUBRIFIANT</a></li>
                                </ul>
                            </li>
                ...
                <div class="slider_area">
                    ...
                    <div id="slides">
                        <ul class="slides-container">
                            <li>
                                <img src="https://mir-s3-cdn-cf.behance.net/project_modules/max_3840/0ed59226911931.5635e0716a0ec.jpg" alt="img">
                                <div class="slider_caption">
                                    <h2>Largest & Beautiful University</h2>
                                    <p>
                                        Grâce à sa présence sur tout le territoire national à travers ses stations-service, son réseau de clients directs, sa large gamme de produits, ses compétences humaines et ses moyens logistiques et techniques, AGIL Lubrifiants couvre aujourd'hui une part importante des besoins du marché national en Lubrifiants.
                                    </p>
                                    <a class="slider_btn" href="http://www.agil.com.tn/fr/httpdoc/lubrifiants-presentation.php">Know More</a>
                                </div>
                            </li>
                        </ul>
                    </div>
