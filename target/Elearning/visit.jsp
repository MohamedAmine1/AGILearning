...
<html>
  <head>
    ...
    <title>AGILearning : Table Visits </title>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="visits">Visites</a></li>
                      </ul>
                  </li>
				   <li class="mt">
                      <a href="Send_to_all">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> visits List</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Username</th>
                                  <th><i class="fa fa-bookmark"></i> Nombre de Visites</th>
                                  <th></th>
                              </tr>
                              </thead>
