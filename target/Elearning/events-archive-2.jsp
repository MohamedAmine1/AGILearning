...
<head>
    ...
    <title>AGILearning : Course Archive</title>
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                            ...
                            <li class="active"><a href="events-archive.jsp">Events</a></li>
        ...
        <div class="single_blog_archive wow fadeInUp">
            <div class="blogimg_container">
                <a href="#" class="blog_img">
                    <img alt="img" src="http://ftbb.org.tn/wp-content/uploads/2017/09/logo-agil.png" style="width:800px;" style="height:400px;">
                </a>
            </div>
            <h2 class="blog_title"><a href="events-single.php"> Changement du nom et du statut de la société AGIP S.A.Tunisie pour devenir "la Société Nationale de Distribution des Pétroles".</a></h2>
            <div class="blog_commentbox">
                <p><i class="fa fa-clock-o"></i>1977</p>
                <p><i class="fa fa-map-marker"></i>Location: Tunisie</p>
            </div>
...
<!-- End single blog archive -->
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 col-sm-12">
                            <div class="single_blog_archive wow fadeInUp">
                                <div class="blogimg_container">
                                    <a href="#" class="blog_img">
                                        <img alt="img" src="http://www.cocerto.fr/wp/wp-content/uploads/2014/02/SA_Societe_anonyme_constitution_associes_infos_entreprise_creation.png">
                                    </a>
                                </div>
                                <h2 class="blog_title"><a href="events-single.php"> La société Nationale de distribution des pétroles devient une société anonyme.</a></h2>
                                <div class="blog_commentbox">
                                    <p><i class="fa fa-clock-o"></i>2000</p>
                                    <p><i class="fa fa-map-marker"></i>Location: Tunisie</p>
                                </div>
                                <p class="blog_summary">Duis erat purus, tincidunt vel ullamcorper ut, consequat tempus nibh. Proin condimentum risus ligula, dignissim mollis tortor hendrerit vel. Aliquam...</p>
                                <a class="blog_readmore" href="events-single.php">Read More</a>
                ...
                <div class="single_blog_prevnext">
                    <a href="events-archive.jsp" class="prev_post wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;"><i class="fa fa-angle-left"></i>Previous</a>
                    <a href="events-archive-2.jsp" class="next_post wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">Next<i class="fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
    </section>
