...
<head>
    ...
    <title>AGILearning : carburant</title>
                        ...
                        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                            ...
                            <li class="dropdown" class="active">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li class="active"><a href="CARBURANT.jsp">CARBURANT</a></li>
                ...
                <div class="slider_area">
                    ...
                    <div id="slides">
                        <ul class="slides-container">
                            <li>
                                <img src="http://kapitalis.com/tunisie/wp-content/uploads/2018/01/Station-Agil.jpg" alt="img">
                                <div class="slider_caption">
                                    <h2>Largest & Beautiful University</h2>
                                    <p>
                                        Occupant la position de leader sur le marché, l'activité Carburants représente l'un des points forts d'AGIL.

                                        Soucieuse de veiller à la qualité des produits qu’elle commercialise et donc de fournir à sa clientèle des produits qui répondent aux spécifications légales, la SNDP s’est dotée de deux laboratoires mobiles équipés des instruments d’analyse les plus performants. Mise en service depuis Mai 2002, l’analyse des échantillons prélevés sur l’ensemble de nos points de vente a corroboré la conformité de nos produits.
                                    </p>
                                    <a class="slider_btn" href="http://www.agil.com.tn/fr/httpdoc/carburants-presentation.php">Know More</a>
                                </div>
                            </li>
                        </ul>
                    </div>
