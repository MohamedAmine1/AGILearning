...
<head >
   <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <title>AGILearning : partenaires</title>
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                            ...
                            <li class="active"><a href="partenaires.jsp">nos partenaires</a></li>
                    ...
                    <div class="courseArchive_content">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single_course wow fadeInUp">
                                    <div class="singCourse_imgarea">
                                        <img src="https://www.eni.com/img/logo-footer.png" style="width:300px;height:300px;"/>
                                        <div class="mask">
                                            <a href="https://www.eni.com/en_IT/home.page" class="course_more">View More</a>
                                        </div>
                                    </div>
                                    <div class="singCourse_content">
                                        <h3 class="singCourse_title"><a href="https://www.eni.com/en_IT/home.page">ENI</a></h3>

                                        <p>Eni S.p.A est une société multinationale italienne de pétrole et de gaz dont le siège est à Rome. Considéré comme l'un des leaders mondiaux, il est présent dans 79 pays et est actuellement le 11ème groupe industriel mondial avec une capitalisation boursière de 68 milliards d'euros au 14 août 2013.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- End single course -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single_course wow fadeInUp">
                                    <div class="singCourse_imgarea">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Logo_NAFTAL.svg/1280px-Logo_NAFTAL.svg.png" style="width:300px;height:300px;" />
                                        <div class="mask">
                                            <a href="http://www.naftal.dz/fr/" class="course_more">View More</a>
                                        </div>
                                    </div>
                                    <div class="singCourse_content">
                                        <h3 class="singCourse_title"><a href="http://www.naftal.dz/fr/">ENI</a></h3>

                                        <p>Naftal est une entreprise algérienne, filiale à 100 % de Sonatrach. Elle est chargée de la distribution des produits pétroliers sur le marché algérien et tunisien1.  Naftal est spécialisée dans la conception, l'élaboration et la distribution de lubrifiants pour moteurs ainsi que pour l'industrie.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- End single course -->
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single_course wow fadeInUp">
                                    <div class="singCourse_imgarea">
                                        <img src="http://www.hec.ca/web_resources/rwd/img/logo_hec_montreal.gif" style="width:300px;height:300px;"/>
                                        <div class="mask">
                                            <a href="http://www.hec.ca/en/" class="course_more">View More</a>
                                        </div>
                                    </div>
                                    <div class="singCourse_content">
                                        <h3 class="singCourse_title"><a href="http://www.hec.ca/en/">HEC Montréal</a></h3>

                                        <p>HEC Montréal est un établissement universitaire francophone dont les programmes d’enseignement et la recherche en gestion sont de renommée internationale. L’École forme une relève en gestion qui contribue à l’essor de la société depuis 1907.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
