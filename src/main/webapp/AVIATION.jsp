...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <title>AGILearning : aviation</title>
                        ...
                        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                            ...
                            <li class="dropdown" class="active">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li class="active"><a href="AVIATION.jsp">AVIATION</a></li>
                ...
                <div class="slider_area">
                    ...
                    <div id="slides">
                        <ul class="slides-container">
                            <li>
                                <img src="http://cms.ukintpress.com/UserFiles/AGILAIR%20-%20Air%20BP%20partner%20in%20Tunisia.jpg" alt="img">
                                <div class="slider_caption">
                                    ...
                                    <a class="slider_btn" href="http://www.agil.com.tn/fr/httpdoc/aviation-presentation.php">Know More</a>
                                </div>
                            </li>
                        </ul>
                    </div>
