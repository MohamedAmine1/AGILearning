...
<html>
  <head>
    ...
    <title>AGILearning : Table Avis </title>
   ...
   <!--  <link href="assets/font-awesome/css/font-awesome.css" rel="stylesheet" /> -->
    ...
    <link href="${pageContext.request.contextPath}/assets/js/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" />
    <!--  <link rel="stylesheet" type="text/css" href="assets/js/bootstrap-daterangepicker/daterangepicker.css" /> -->
    <link href="${pageContext.request.contextPath}/assets/js/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet" />
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="avis">Avis</a></li>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Avis List</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>#ID</th>
                                  <th><i class="fa fa-bookmark"></i> Titre Formation</th>
                                  <th><i class="fa fa-bookmark"></i> Question 1</th>
                                  <th><i class="fa fa-bookmark"></i> Question 2</th>                                  
								  <th><i class="fa fa-bookmark"></i> Question 3</th>
								  <th><i class="fa fa-bookmark"></i> Question 4</th>
